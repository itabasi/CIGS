...
void VW_draw(){
  ...
  rname[4] = "~/work/SENSOR/CIGS/Ana/analysis/itamacro/RootFiles/CIGS22_0h_VW.root";
  ...
  cout<<"scale ch0 "<<scale[0]<<" ch1 "<<scale[1]<<endl;
  ...
  gCH0_s[0]->Draw("PCL PMC AP");
  gCH1_s[0]->Draw("PCL PMC P");
  gCH0_s[4]->Draw("PCL PMC P");
  gCH1_s[4]->Draw("PCL PMC P");  
  
  TLegend*leg3 = new TLegend(0.5,0.80,0.98,0.98,"","NDC");
  leg3->AddEntry(gCH0_s[0], "CIGS 2#mum CH0 ","pe");
  leg3->AddEntry(gCH1_s[0], "CIGS 2#mum CH1 ","pe");
  leg3->AddEntry(gCH0_s[4], "CIGS 5#mum CH0 ","pe");
  leg3->AddEntry(gCH1_s[4], "CIGS 5#mum CH1 ","pe");
  leg3->Draw();
  ...
  c4->cd();
  gCH0_s[0]->SetTitle(";Voltage [V] ; deplation width [#mum]");
  gCH0_s[0]->GetXaxis()->SetRangeUser(-2,0);
  gCH0_s[0]->GetXaxis()->SetTitleSize(0.06);
  gCH0_s[0]->GetYaxis()->SetTitleSize(0.06);
  gCH0_s[0]->GetXaxis()->SetLabelSize(0.04);
  gCH0_s[0]->GetYaxis()->SetLabelSize(0.04);
  gCH0_s[0]->Draw("PCL PMC AP");
  //  gCH1_s[0]->Draw("PCL PMC P");
  gCH0_s[4]->Draw("PCL PMC P");
  //  gCH1_s[4]->Draw("PCL PMC P");  
  
  TLegend*leg4 = new TLegend(0.2,0.20,0.65,0.5,"","NDC");
  leg4->AddEntry(gCH0_s[0], "2#mum thickness CIGS ","p");
  leg4->AddEntry(gCH0_s[4], "5#mum thickness CIGS ","p");
  leg4->Draw();
