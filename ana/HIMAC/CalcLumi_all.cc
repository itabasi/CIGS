...
//const int nrun =29;
const int nrun =26;
const int runID[nrun]={38, 39, 40, 41, 42, 43, 44, 45, 46, 48, 49, 50, 53, 54, 55, 60, 73, 75, 76, 78, 79, 80, 81, 82, 83, 84};
...
void CalcLumi_all(){
  ...
  string ofp_name ="./runlist/luminosity_all.txt";
...
int unixt_run(int runnum){
  ...
  // ==== after 2nd anealing
  unixt[21] = 1669402920; // Run80 2022/11/26 04:02:00
  unixt[22] = 1669406400; // Run81 2022/11/26 05:00:00
  unixt[23] = 1669411200; // Run82 2022/11/26 06:20:00
  unixt[24] = 1669414140; // Run83 2022/11/26 07:09:00
  unixt[25] = 1669416180; // Run84 2022/11/26 07:43:00
  //const int runID[nrun]={38, 39, 40, 41, 42, 43, 44, 45, 46, 48, 49, 50, 53, 54, 55, 60, 73, 75, 76, 78, 79, 80, 81, 82, 83, 84};
